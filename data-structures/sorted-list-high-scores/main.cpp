...
int main()
{
	...
	*/
	...
	while (true)
	{
		...
		{
			int length = scores.getLength();
			for (int i = 1; i <= scores.getLength(); i++)
			{
				cout << scores.getEntry(i) << endl;
			}
		}

		// Ask user for a new score
		cout << "\nEnter a new score (negative number to quit): ";
		cin >> newScore;
...
Enter a new score (negative number to quit): 100

Current High Scores:
100

Enter a new score (negative number to quit): 50

Current High Scores:
100
50

Enter a new score (negative number to quit): 75
...
Enter a new score (negative number to quit): 25
...
Enter a new score (negative number to quit): 0
...
Enter a new score (negative number to quit): -1
